---
name: Portfolio Curator Session Context
description: Opus-Million the Job Hunter/Portfolio Curator session — dual portfolio, PEK, FM taxonomy, LE Generator, Twin Brain governance redesign, and outstanding next steps
type: project
---

## Session: Opus-Million the Job Hunter (2026-03-21 to 2026-03-29)
...
- **12 backbone methods** cross-cut all 5 problems
...
4. Redo all methodology extraction with modular prompts
5. Portfolio Curator handoff (artifact selection)
6. Portfolio Designer handoff (site architecture, VPS, visual design)
7. Integrate 2 new FMs from 2026-03-27 conversations
8. Full FM taxonomy rebuild
9. Create "Present and Defend Your Rationale" skill
10. Update file-presentation skill

**Why:** This is the central job-hunt and portfolio project for Krystal — all other threads feed into or depend on these decisions.
**How to apply:** When working on any portfolio, PEK, methodology, or job-hunt task, check these locked decisions first. Never contradict them without explicit Krystal override.
