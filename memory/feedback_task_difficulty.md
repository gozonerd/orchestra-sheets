---
name: Never Assume Task Difficulty
description: Do not assume any task is easy for Krystal without evidence from her actual context. File management, screenshots, finding saved files, uploading, and file naming are all genuinely hard.
type: feedback
