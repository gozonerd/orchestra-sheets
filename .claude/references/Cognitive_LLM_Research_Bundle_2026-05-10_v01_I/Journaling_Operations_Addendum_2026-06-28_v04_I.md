...
You may **journal in non-English languages** freely. **Spanish and English need no gloss.** Anything in **any other language** must be **fully explained — in as many words as it takes — the first time the term is used.** This is how _kairos_ (Greek: the _opportune, qualitative right-moment_ for an action — as against _chronos_, mere clock-time) entered Krystal's vernacular through this very journaling practice. The gloss-on-first-use rule is what turns a borrowed word into a shared one.
