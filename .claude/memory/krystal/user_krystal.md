---
name: Krystal Martinez — User Profile
description: Krystal's role, working style, ADHD accommodations, co-collaborator Cody, and AI-first company context
type: user
...
Previous Claude Code instance was named "Opus-Million the Repo Wrangler" (OM Repo Wrangler). That was a multi-day session (2026-03-24 to 2026-03-29) on old laptop (username: Krystal Martinez). Current laptop username: NerdyKrystal. Fresh Claude Code install — no configs carried over, only repos (cloned from git) and exported transcripts.

Co-collaborator Cody works in the same repos, especially stahl-systems-docs and StrongMinds-DMIS. Cody was building a portfolio website (frontend-design plugin kept for this).
