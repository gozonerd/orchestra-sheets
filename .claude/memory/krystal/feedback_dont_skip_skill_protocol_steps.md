...
- If the protocol genuinely doesn't fit the situation, _surface that to Krystal_ with the proposed deviation and the reason — let her decide whether to skip
