...
- The exception is Stage 01a's skeleton-approval step (the user's explicit decision point on the stage list) and any time a hook _blocks_ the commit — those are real interruptions, not optional pauses.
