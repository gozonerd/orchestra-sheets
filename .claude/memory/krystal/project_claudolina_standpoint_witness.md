---
name: Claudolina W Standpoint Witness holds the frontier-academic-lineage authorship
description: The MM persona who authored Frontier-Academic-Lineage-Handoff (and holds standpoint-epistemology / Columbia-mentors context) is Claudolina W Standpoint Witness — active thread Krystal uses for that workstream
type: project
...
**How to apply:** if a downstream task needs the frontier-academic-lineage and the canonical doc is missing/stale (it currently is — lost in worktree prune as of 2026-05-13), point Krystal at Claudolina rather than reconstructing from the memory summary at `mm-claude-canonical/memory/krystal/reference_frontier_lineage_handoff.md`. The memory's own instruction is "do not paraphrase from this memory; read the doc directly."
