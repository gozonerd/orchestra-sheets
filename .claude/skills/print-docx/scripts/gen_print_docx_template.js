					...
					(h, j) =>
						new TableCell({
							...
							children: [
								new Paragraph({
									children: [
										new TextRun({ text: h, bold: true, size: 20, font: FONT, color: 'FFFFFF' })
									]
								})
							]
						})
							...
							(cell, j) =>
								new TableCell({
									...
									children: [
										new Paragraph({
											spacing: { line: 360 },
											children: [new TextRun({ text: cell, size: 20, font: FONT })]
										})
									]
								})
						)
...
const titlePage = {
	...
	children: [
		new Paragraph({
			spacing: { before: 2000 },
			alignment: AlignmentType.CENTER,
			children: [new TextRun({ text: CONFIG.title, font: FONT, size: 48, bold: true })]
		}),
		...(CONFIG.subtitle
			? [
					p(
