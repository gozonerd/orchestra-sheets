---
name: brainstorm-cover-letter
description: "Brainstorm a cover letter the right way: ground in the ACTUAL job description, derive angles FROM it, and ask Krystal which anecdotes she has — never build a thesis from a paraphrase or one cherry-picked story. Triggers on: '/brainstorm-cover-letter', 'brainstorm cover letter', 'brainstorm the cover letter', 'cover letter angles', 'help me brainstorm the cover letter'. Invokes check-jd first to source the LIVE posting (cover letters are prospective). Beginner's mind: read the real JD, float 3–5 angles each citing verbatim JD phrases, ask which Krystal has a real anecdote for, then build around the strongest one or two — AIGHVA, her voice, third parties anonymized."
---

# brainstorm-cover-letter — angles grounded in the real JD, not vibes
...
- **AIGHVA** — every claim verbatim-traceable or omitted; **underclaim** when unsure; never fabricate, never round up.
- **Verb law** — she **designs / architects / directs AI to build**; never "coded / built software." "Built a curriculum / taxonomy / assessment" is fine.
- **Anonymize** real third parties (first-name-only or omit); blind student / third-party data before any public use.
- **Her send** — the cover letter is hers to verify and send. Surface it; never transmit on her behalf or enter her credentials.
- Exact-version + provenance rules live in **check-jd** — honor them; re-check angles against the verbatim posting before the letter is final.
