...
<div class="flex h-screen bg-gray-50">
	...
	<button
		...
		class="fixed right-4 bottom-4 z-40 rounded-lg bg-blue-600 p-2 text-white md:hidden"
			...
			<div class="px-6 py-4">
				<div class="mb-4 flex items-center justify-between gap-4">
					...
					<button
						...
						class="flex items-center gap-2 rounded-lg bg-blue-50 px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-100 focus:ring-2 focus:ring-blue-500 focus:outline-none"
